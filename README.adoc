...
If you wish to make a contribution (typo, modification, or new content), you must become a contributor and follow the <<contributing_site#,contribution process>>.
