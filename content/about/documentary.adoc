...
* https://www.youtube.com/watch?v=zhZMaF8vq5Y[Strange Loop Language Panel (2011)] - A fun panel of language designers including Rich Hickey and Gerald Sussman.
* https://www.youtube.com/watch?v=-6BsiVyC1kM[The Value of Values (2012)] — The case for immutable values over mutable objects.
* https://www.infoq.com/presentations/Datomic/[Writing Datomic in Clojure (2012)] - An overview of Datomic and how Clojure was the perfect language to write it in.
...
* https://clojure.org/community/etiquette[Clojure Etiquette] - derived from Rich's original post to the mailing list.
...
[width="80", cols="<.^20a,.^80", role="table", options="header"]
|===
| Term | Definition
