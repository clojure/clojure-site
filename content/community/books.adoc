...
| image::https://blog.klipse.tech/assets/get_programming_clojure_small.jpg[Get Programming with Clojure,link="https://www.getprogrammingwithclojure.com"]
| https://www.getprogrammingwithclojure.com[Get Programming with Clojure] +
