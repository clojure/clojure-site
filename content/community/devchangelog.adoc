...
* Alpha - new feature work and enhancements still in development
* Beta - new feature work for the release is complete, fixing bugs only
* RC - a release candidate, which will be released as a final release unless a critical issue is found
