...
* https://dev.clojure.org/jira/browse/CLJ-2504[CLJ-2504] Provide more options for error reporting in clojure.main

=== 1.10.1-beta2 (Apr 11, 2019)

* https://dev.clojure.org/jira/browse/CLJ-2497[CLJ-2497] Put error report location on its own line
* https://dev.clojure.org/jira/browse/CLJ-2499[CLJ-2499] Some compiler expr evals report as wrong phase
