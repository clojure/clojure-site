...
[source]
----
https://repo1.maven.org/maven2/org/clojure/clojure/1.10.1/clojure-1.10.1.jar
----
...
[source]
----
curl -O https://repo1.maven.org/maven2/org/clojure/clojure/1.10.1/clojure-1.10.1.jar.asc
----
...
This reports a good signature (the content is what was signed) but warns that this key is not trusted in your GPG configuration.  Marking the key is trusted is beyond the scope of this page but you can manually verify by comparing to the official key above.
