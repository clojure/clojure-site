...
Clojure depends on Java and all Clojure code is compiled to Java 8 compatible bytecode. At runtime, Clojure depends on the JVM (Java Virtual Machine):

* Minimum: Java 8
* Supported: LTS (long term support) releases, currently Java 8 and Java 11
* Others: may work, not officially supported
