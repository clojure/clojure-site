...
== Development Release: 1.9.0-alpha19 (Aug 24, 2017)

* https://repo1.maven.org/maven2/org/clojure/clojure/1.9.0-alpha19/clojure-1.9.0-alpha19.zip[Clojure 1.9.0-alpha19]
