            ...
            <div class='small-12 columns'>
              <ul class='small-block-grid-1 large-block-grid-3 case-study-tiles'>
                ...
                <li>
                  ...
                  <p>
                    <a target="pisano" href="https://www.pisano.co">Pisano’s</a> empowering & innovative customer experience platform uses Clojure, ClojureScript and Datomic.
                  </p>
                  <hr>
                  <p>
                    <span class='read-more'>Read why Pisano is so happy with using the Clojure platform.</span>
                  </p>
                  <blockquote style='margin-left: 0; padding: 0'>
