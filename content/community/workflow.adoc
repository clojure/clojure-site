...
* Who: Screeners
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10371[Open tickets] 
...
* Who: Screeners
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10370[Triaged tickets]
...
* Who: Rich
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10370[Triaged] and http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10511[Prescreened] tickets
...
* Who: Rich
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10376[Vetted tickets]
...
*** If does not have patch, will show up in http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10373[Needs Patch] report
*** If does have patch, will show up in http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10374[Screenable] report

**Dev patch**

* Who: contributors (anyone with signed CA)
* Report: 
** http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10373[Needs Patch] - for tickets that need a patch
** http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10375[Incomplete] tickets - for tickets that have patches that need work
...
* Who: Screeners
* Reports: 
** http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10374[Screenable] tickets (for new vetted tickets with patches)
** http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10375[Incomplete] tickets that have changed recently - need to re-review if submitter has updated ticket since marked Incomplete.
...
* Checks (see <<creating_tickets#,Creating Tickets>> and <<developing_patches#,Developing Patches>> and <<screening_patches#,Screening Patches>>):
  . Is there a patch?
  . Is there a test?
...
* Who: Rich 
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10383[Screened tickets]
...
* Who: Stu H (usually)
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10377[OK tickets] 
...
* Who: Rich (primarily)
* Report: http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10372[Backlog tickets]
...
*** http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10371[Open] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10370[Triaged] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10511[Prescreened] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10376[Vetted] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10378[Declined] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10372[Backlog]
** Next release work queues
*** http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10373[Needs Patch] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10374[Screenable] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10375[Incomplete] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10383[Screened] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10377[Ok] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10379[Accepted] | http://dev.clojure.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10380[Closed]
** Other
