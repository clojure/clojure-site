...
First, please consider the <<xref/../../community/contributing#,many ways to contribute>> as a Clojure user. If you simply need to file a bug, https://clojure.atlassian.net/servicedesk/customer/portal/1[you can do so] without becoming a contributor. 
