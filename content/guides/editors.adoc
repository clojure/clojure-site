...
It's unique, powerful UI is popular enough that most other editors mentioned above include vi-modes that reproduce Vim's core UI functionality.
...
* https://github.com/guns/vim-sexp - precision editing of S-expressions
* https://github.com/tpope/vim-sexp-mappings-for-regular-people - alternative keybindings that some users may prefer
* https://github.com/tpope/vim-surround - makes it easier to wrap expressions in brackets, quotes, and other tokens.
