...
https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html#equals-java.lang.Object-[J`equals`].
...
* https://github.com/clojure/data.priority-map[data.priority-map]
* https://github.com/flatland/ordered[flatland/ordered-set]
