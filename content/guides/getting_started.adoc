...
[source,shell]
----
curl -O https://download.clojure.org/install/linux-install-1.10.3.833.sh
chmod +x linux-install-1.10.3.833.sh
sudo ./linux-install-1.10.3.833.sh
----
...
[source,shell]
----
sudo ./linux-install-1.10.3.833.sh --prefix /opt/infrastructure/clojure
----
