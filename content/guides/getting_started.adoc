...
[source,shell]
----
sudo ./linux-install-1.10.1.754.sh --prefix /opt/infrastructure/clojure
----
...
Build tools provide a range of capabilities for building, running, and deploying Clojure libraries and applications. The two most popular Clojure build tools are https://leiningen.org/[Leiningen] and https://boot-clj.github.io/[Boot].
