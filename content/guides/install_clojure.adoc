...
Clojure requires Java. Clojure officially supports Java LTS releases (currently Java 8, 11, and 17), but also tries to ensure interim versions work as well. If you don't already hava Java installed, we recommend installing Adoptium Temurin 17.
...
On Mac, you can install using brew:

* `brew install --cask temurin` - install latest Temurin (formerly AdoptOpenJDK)
