...
[source,shell]
----
sudo ./linux-install-1.11.1.1257.sh --prefix /opt/infrastructure/clojure
----
...
[source,shell]
----
curl -O https://download.clojure.org/install/posix-install-1.11.1.1257.sh
chmod +x posix-install-1.11.1.1257.sh
sudo ./posix-install-1.11.1.1257.sh
----
...
[source,shell]
----
sudo ./posix-install-1.11.1.1257.sh --prefix /opt/infrastructure/clojure
----
