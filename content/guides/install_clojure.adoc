...
[source,shell]
----
curl -O https://download.clojure.org/install/linux-install-1.11.1.1119.sh
chmod +x linux-install-1.11.1.1119.sh
sudo ./linux-install-1.11.1.1119.sh
----
...
[source,shell]
----
sudo ./linux-install-1.11.1.1119.sh --prefix /opt/infrastructure/clojure
----
