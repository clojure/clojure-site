...
[source,shell]
----
curl -O https://download.clojure.org/install/linux-install-1.11.1.1129.sh
chmod +x linux-install-1.11.1.1129.sh
sudo ./linux-install-1.11.1.1129.sh
----
...
[source,shell]
----
sudo ./linux-install-1.11.1.1129.sh --prefix /opt/infrastructure/clojure
----
