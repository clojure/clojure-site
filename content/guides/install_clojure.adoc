...
[source,shell]
----
sudo ./linux-install-1.11.1.1262.sh --prefix /opt/infrastructure/clojure
----
...
[source,shell]
----
curl -O https://download.clojure.org/install/posix-install-1.11.1.1262.sh
chmod +x posix-install-1.11.1.1262.sh
sudo ./posix-install-1.11.1.1262.sh
----
...
[source,shell]
----
sudo ./posix-install-1.11.1.1262.sh --prefix /opt/infrastructure/clojure
----
