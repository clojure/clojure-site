...
[source,shell]
----
curl -O https://download.clojure.org/install/linux-install-1.11.1.1267.sh
chmod +x linux-install-1.11.1.1267.sh
sudo ./linux-install-1.11.1.1267.sh
----
...
[source,shell]
----
sudo ./linux-install-1.11.1.1267.sh --prefix /opt/infrastructure/clojure
----
...
[source,shell]
----
curl -O https://download.clojure.org/install/posix-install-1.11.1.1267.sh
chmod +x posix-install-1.11.1.1267.sh
sudo ./posix-install-1.11.1.1267.sh
----
...
[source,shell]
----
sudo ./posix-install-1.11.1.1267.sh --prefix /opt/infrastructure/clojure
----
