...
Note that the printed result is a valid form that the Reader could read again. Both human- and machine-readable printing functions are useful in different contexts.
