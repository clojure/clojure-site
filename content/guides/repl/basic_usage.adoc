...
But the REPL also lets you use pre-existing Clojure code, i.e Clojure <</reference/libs#,libs>>.footnote:[
Note that what we call a Clojure <</reference/libs#,lib>> is not necessarily a https://en.wikipedia.org/wiki/Library_(computing)[library]:
