...
;;=> #acct.Person{:first-name "Bugs", :last-name "Bunny", 
...
(person-name 42)
;;=> java.lang.AssertionError: Assert failed: (s/valid? :acct/person person)
...
[source,clojure]
----
(s/def :bolwing/roll (s/int-in 0 11))
