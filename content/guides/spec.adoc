...
[source, clojure]
----
[org.clojure/clojure "1.9.0-alpha2"]
----
...
In addition to `explain`, you can use http://clojure.github.io/clojure/branch-master/clojure.spec-api.html#clojure.spec/explain-data[`explain-data`] to receive the errors as data, which can be attached to an exception or acted upon for further analysis.
