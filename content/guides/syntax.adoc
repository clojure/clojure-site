...
image:/images/content/guides/syntax/traditional-evaluation.png["Java evaluation"]
...
image:/images/content/guides/syntax/clojure-evaluation.png["Clojure evaluation"]
...
image:/images/content/guides/syntax/structure-and-semantics.png["Structure and semantics"]
