...
* More string functions in http://clojure.github.io/clojure/clojure.string-api.html[clojure.string] (portable to ClojureScript): index-of, last-index-of, starts-with?, ends-with?, includes?
