...
$ clojure -Sverbose
version      = 1.11.1.1165
install_dir  = /usr/local/Cellar/clojure/1.11.1.1165
config_dir   = /Users/alex/.clojure
config_paths = /usr/local/Cellar/clojure/1.11.1.1165/deps.edn /Users/alex/.clojure/deps.edn deps.edn
cache_dir    = /Users/alex/.clojure/.cpcache
cp_file      = /Users/alex/.clojure/.cpcache/304695339.cp
...
`-Sdeps` is useful when experimenting with libraries without creating a concrete `deps.edn` file. Note that due to escaping rules, it's best to wrap the config data in single quotes.
