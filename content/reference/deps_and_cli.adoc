...
When you execute the Clojure tool, there are a series of steps performed to prepare and execute your command. This section is an overview of those steps, see the next section for how to modify those steps in a variety of ways.
...
Other options that can be provided to `clj` (all of these effectively short circuit normal execution):
