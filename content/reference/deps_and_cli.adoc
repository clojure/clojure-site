...
[source,shell]
----
clj -T:deps install-tool io.github.clojure/tools.deps.graph '{:git/tag "tools.deps.graph-1.0.56"}' :as deps-graph
----
...
* Install tool with `clj -T:deps install-tool io.github.MY/TOOL '{:git/tag "VERSION"}' :as NAME`
