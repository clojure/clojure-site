...
The `clojure` tool is a shell script for invoking Clojure. 
The `clj` tool is a wrapper script designed for interactive repl use. 
These tools ultimately construct and invoke a command-line of the form:
