...
Depending on the varargs type, use the type-specific array constructors for primitives or `into-array` to make an array of a specific type.

See the <<xref/../../guides/faq#varargs,FAQ>> for examples.
