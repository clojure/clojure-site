...
(Notice that this will attach the type hint to the arguments vector, which is preferred. To obtain e.g. the first one, you would need to do `(-> #'hinted meta :arglists first meta :tag)`.)
