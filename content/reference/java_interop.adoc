...
**(Classname/member [instance] args*)**
...
`(Classname. args*) ;note trailing dot, OR` +
`(Classname/new args*)`

These both expand into the former at macro expansion time.
