...
You should extend a protocol to a type only if you control the type, the protocol, or both. This is particularly important for the protocols included with Clojure itself. For more information see the https://groups.google.com/d/topic/clojure/vyX5-F3NiVg/discussion[mailing list discussion].
