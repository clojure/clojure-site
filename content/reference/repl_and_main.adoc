...
Other programs may wish to take advantage of this functionality, and it is available in https://clojure.github.io/clojure/branch-master/clojure.main-api.html#clojure.main/report-error[report-error], which takes a Throwable and optionally the :target.
