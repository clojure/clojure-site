...
A keyword arguments declaration of the form shown for `foo` below is equivalent to the same using `let`, demonstrating associative destructuring’s interpretation of seqs:
