...
A keyword arguments declaration of the form shown for `foo` below is equivalent to using a map destructuring form on the __rest-param__, demonstrating associative destructuring’s interpretation of seqs:
