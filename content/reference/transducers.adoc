...
Also see the introductory http://blog.cognitect.com/blog/2014/8/6/transducers-are-coming[blog post], this https://www.youtube.com/watch?v=6mTbuzafcII[video], and this section of the FAQ https://clojure.org/guides/faq#transducers_vs_seqs[about good use cases for transducers].
