...
* https://clojure.atlassian.net/browse/CLJ-2123[CLJ-2123] Add :as-alias option to require like :as but does not load
* https://clojure.atlassian.net/browse/CLJ-1959[CLJ-1959] Added implementation of update-keys and tests
* https://clojure.atlassian.net/browse/CLJ-2651[CLJ-2651] Added implementation of update-vals and tests
* https://clojure.atlassian.net/browse/CLJ-1098[CLJ-1098] Add clojure.test api to run single test with fixtures and report
...
* https://clojure.atlassian.net/browse/CLJ-2387[CLJ-2387] Fixed off-by-one in socket server port validation
