...
[source]
----
https://repo1.maven.org/maven2/org/clojure/clojure/1.10.2/clojure-1.10.2.jar
----
...
[source]
----
curl -O https://repo1.maven.org/maven2/org/clojure/clojure/1.10.2/clojure-1.10.2.jar.asc
----
...
----
$ gpg --verify clojure-1.10.2.jar.asc ~/.m2/repository/org/clojure/clojure/1.10.2/clojure-1.10.2.jar
