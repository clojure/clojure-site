...
[source]
----
https://repo1.maven.org/maven2/org/clojure/clojure/1.11.0/clojure-1.11.0.jar
----
...
[source]
----
~/.m2/repository/org/clojure/clojure/1.11.0/clojure-1.11.0.jar
----
...
[source]
----
curl -O https://repo1.maven.org/maven2/org/clojure/clojure/1.11.0/clojure-1.11.0.jar.asc
----
...
----
$ gpg --verify clojure-1.11.0.jar.asc ~/.m2/repository/org/clojure/clojure/1.11.0/clojure-1.11.0.jar
