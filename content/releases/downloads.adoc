...
== Stable Release: 1.11.0 (Mar 22, 2022)
...
Clojure 1.11.0 depends on the following core libraries:
...
== Development Release: 1.11.1-rc1 (Apr 1, 2022)

* Clojure 1.11.1-rc1
* https://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.clojure%22%20AND%20a%3A%22clojure%22%20AND%20v%3A1.11.1*[Clojure 1.1
1.1 pre-release builds]
