...
== Stable Release: 1.10.2 (Jan 26, 2021)
...
Clojure 1.10.2 depends on the following core libraries:
...
== Development Release: 1.10.3-rc1 (Jan 15, 2021)

* Clojure 1.10.3-rc1
* https://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.clojure%22%20AND%20a%3A%22clojure%22%20AND%20v%3A1.10.3*[Clojure 1.10.3 pre-release builds]
