...
[[stable]]
== Stable Release: 1.12.6 (Sep 2, 2026)
...
Clojure 1.12.6 depends on the following core libraries:
...
[[dev]]
== Development Release: 1.13.0-alpha7
...
** `org.clojure/core.specs.alpha {:mvn/version "0.6.133-alpha10"}`
