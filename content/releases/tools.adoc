...
=== 1.10.3.875 (May 25, 2021) [[v1.10.3.875]]

* New: support for specifying multiple functions with -X with `pass:[->]` semantics
* https://clojure.atlassian.net/browse/TDEPS-182[TDEPS-182] - Improve deprecation message to be more accurate
...
* Use https://github.com/clojure/tools.deps.alpha/blob/master/CHANGELOG.md[tools.deps.alpha] 0.11.931
