...
* https://clojure.atlassian.net/browse/TDEPS-265[TDEPS-265] - `-Ttools install-latest` when :coord with git url provided
* https://clojure.atlassian.net/browse/TDEPS-268[TDEPS-268] - `-X:deps find-versions` returns all procurer types
